...
class StaffItemPage extends StatefulWidget {
  Items? model;
  StaffItemPage({super.key, this.model});
            ...
            TextButton(
              onPressed: () {
                ...
                FirebaseFirestore.instance
                  ...
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (c) => const StaffHomeScreen()));
                });
        ...
        children: [
          ElevatedButton.icon(
            ...
            style: ButtonStyle(
              ...
              padding: const MaterialStatePropertyAll(EdgeInsets.symmetric(horizontal: 40, vertical: 15),),
              shape: MaterialStatePropertyAll(RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(10))),
            ),
            icon: const Icon(CupertinoIcons.delete),
            label: const Text('Delete', style: TextStyle(fontWeight: FontWeight.bold,fontSize:16,),),
          )],
      ),
    );
  }
